...
<body class="g-sidenav-show bg-gray-100">
                    ...
                    <div id="myModalBody">
                            ...
                            <form class="table-responsive bg-faded rounded p-5" name="roster" id="${e_id}">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tr scope="row">
                                        ...
                                        <td class="table-info">
                                            <input id="confirmNewPass" name="confirmNewPass">
                                        </td>
                                    </tr>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary"
                                onclick="passwordFormReset(this)">Cancel</button>
                            <button type="button" class="btn btn-primary"
                                onclick="changePasswordHandler(this)">Confirm</button>
                        </div>
                    </div>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-uppercase text-primary text-xl font-weight-bolder opacity-7 ps-2"
                                                id="rosterControl">
                                                <a href="javascript:;" id="addRoster">
                                                    <i class="fa fa-plus-circle fixed-plugin-button-nav cursor-pointer me-2 text-secondary"
                                                        aria-hidden="true"></i><small
                                                        class="text-secondary">Add</small></a>
                                                <span
                                                    class="text-uppercase text-secondary text-xl font-weight-bolder opacity-7 ps-5">
                                                </span>
                                                ...
                                                <span
                                                    class="text-uppercase text-primary text-xl font-weight-bolder opacity-7">
                                                </span>
                                            </th>
                                            <th
                                                class="text-uppercase text-primary text-xl font-weight-bolder opacity-7 ps-2">
    ...
    <script src="../assets/js/darpan-db.min.js" defer></script>
</body>
