...
// const mobileMenu = () => {
//   if (menu.children[0].getAttribute("id")) {
//     menu.innerHTML = `<i class="text-white p-0 fas fa-times cursor-pointer"></i>`;
//   } else {
//     menu.innerHTML = `<i class="text-white p-0 fas fa-bars cursor-pointer" id="bars"></i>`;
//   }
// };
...
const buildPagination = () => {
  ...
  //               <a class="page-link" href="#" value="${i + 1}">
  //               ${i + 1}
  //               </a>
  //             </li>`;
  // }
  ...
  newDataArr.forEach((e) => {
    content += `
                    <tr id="${e["id"]}" >
                        ...
                        <td class="align-middle edit-btn">
                            <a href="javascript:;" class="text-secondary font-weight-bold text-xs"
                            onclick="selectRoster(this)"
                                 >
                                Edit
                            </a>
                        </td>
